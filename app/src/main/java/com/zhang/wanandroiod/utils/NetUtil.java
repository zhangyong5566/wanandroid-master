        ...
        if (ni != null && ni.isConnectedOrConnecting()) {
            ...
            switch (ni.getType()) {//获取当前网络的状态
                case ConnectivityManager.TYPE_WIFI:// wifi的情况下
                    ...
                    Toast.makeText(MyApplication.getApplictaion(),"切换到wifi环境下",Toast.LENGTH_SHORT).show();
                    break;
                case ConnectivityManager.TYPE_MOBILE:
                    ...
                    switch (ni.getSubtype()) {
                        ...
                        case TelephonyManager.NETWORK_TYPE_IDEN:
                            ...
                            PlayAndroidToast.info("切换到2G环境下");
                            break;
                        ...
                        case NETWORK_TYPE_TD_SCDMA:
                            netType = NETWORK_3G;
                            PlayAndroidToast.info("切换到3G环境下");
                            break;
                        case TelephonyManager.NETWORK_TYPE_LTE:

                        case NETWORK_TYPE_IWLAN:
                            netType = NETWORK_4G;
                            PlayAndroidToast.info("切换到4G环境下");
                            break;
                        default:
            ...
            netType = NETWORK_NO;
            PlayAndroidToast.error(context, "当前无网络连接").show();
        }
        return netType;
    }
